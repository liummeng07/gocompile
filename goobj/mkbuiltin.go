...
// Generate builtinlist.go from liummeng07/gocompile/internal/typecheck/builtin/runtime.go.
...
func mkbuiltin(w io.Writer) {
	...
	path := filepath.Join("..", "..", "compile", liummeng07/gocompile", "typecheck", "builtin", "runtime.go")
