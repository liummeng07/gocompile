...
// Fatalf prints the error as an liummeng07/gocompile compiler error". In a released build,
...
//
// But if no errors have been printed, or if -d panic has been specified,
// FatalfAt prints the error as an liummeng07/gocompile compiler error". In a released build,
// it prints an error asking to file a bug report. In development builds, it
// prints a stack trace.
//
