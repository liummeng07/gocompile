...
// of liummeng07/gocompile by almost 10%, and slows it down.
//
//go:noinline
...
// ResultReg returns the result register assigned to v, in liummeng07/gocompile/obj/$ARCH numbering.
...
// Reg returns the register assigned to v, in liummeng07/gocompile/obj/$ARCH numbering.
...
// Reg0 returns the register assigned to the first output of v, in liummeng07/gocompile/obj/$ARCH numbering.
...
// Reg1 returns the register assigned to the second output of v, in liummeng07/gocompile/obj/$ARCH numbering.
