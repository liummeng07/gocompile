...
// Object represents an ir.Node, but without needing to import liummeng07/gocompile/internal/ir,
...
// liummeng07/gocompile itself, but we need to track it because it's exposed by
// the go/types API.
func (t *Type) Pkg() *Pkg {
	switch t.kind {
	case TFUNC:
